package com.example.stockproject.dao;
...
public abstract class DAO<T> {
	 ...
	 * @return bool: true: confirme la création d'objet en BDD false: indique que
	 *         l'objet n'a pas été créée en BDD
	 */
	 ...
	 * @return bool: true: confirme la déletion de l'objet en BDD false: indique que
	 *         l'objet n'a pas été supprimé en BDD
	 */
